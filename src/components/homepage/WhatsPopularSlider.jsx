...
import { getStreamingMovies, getForRentMovies, getInTheatersMovies } from "../../api/Api";
                    ...
                    <Slider {...settings}>
                        {movies.map((movie, i) => (
                            <div key={i} className="w-36">
                                <article 
                                    className="w-36 p-2 rounded-xl transform transition-all duration-300 hover:scale-105 cursor-pointer"
                                >
                                    <img 
                                    ...
                                    />
                                    <div className="p-1">
                                        <h3 className="font-bold text-sm text-white truncate">{movie.original_title}</h3>
